...
public class ThrottlingMiddleware extends Middleware
{
     ...
     *
     * This gives much more flexibility than a simple loop over all middleware objects. For instance, an element
     * of a chain can change the order of checks by running its check after all other checks.
     *
     * */
